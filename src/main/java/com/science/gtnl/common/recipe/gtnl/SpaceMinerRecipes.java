...
public class SpaceMinerRecipes implements IRecipePool {
    ...
    @Desugar
    private record OreGroup(ItemStack circuit, ItemStack[] outputs) {}
    ...
    static {
        ...
        ORE_GROUPS = Arrays.asList(
            new OreGroup(
                ...
                GTUtility.copyAmountUnsafe(80, GTOreDictUnificator.get(OrePrefixes.ore, Materials.DraconiumAwakened, 1)),
            ...
            new OreGroup(
                ...
                GTUtility.copyAmountUnsafe(120, GTOreDictUnificator.get(OrePrefixes.ore, Materials.VanadiumMagnetite, 1)),
            ...
            new OreGroup(
                ...
                GTUtility.copyAmountUnsafe(80, GTOreDictUnificator.get(OrePrefixes.ore, Materials.TricalciumPhosphate, 1)),
            ...
            new OreGroup(
                ...
                GTUtility.copyAmountUnsafe(240, GTOreDictUnificator.get(OrePrefixes.ore, Materials.BasalticMineralSand, 1)),
                GTUtility.copyAmountUnsafe(160, GTOreDictUnificator.get(OrePrefixes.ore, Materials.GraniticMineralSand, 1)),
            ...
            new OreGroup(
                ...
                GTUtility.copyAmountUnsafe(160, GTOreDictUnificator.get(OrePrefixes.ore, Materials.VanadiumMagnetite, 1)),
                ...
                GTUtility.copyAmountUnsafe(60, GTModHandler.getModItem(Mods.HardcoreEnderExpansion.ID, "end_powder_ore", 1)),
            ...
            new OreGroup(
                ...
                GTUtility.copyAmountUnsafe(80, aeBlocks.skyStone().maybeStack(1).orNull()),
    ...
    private void addSpaceMinerRecipe(OreGroup group, FuelVariant fuel) {
        RecipeBuilder.builder()
            .itemInputs(group.circuit(), ItemList.MiningDroneUV.get(0))
