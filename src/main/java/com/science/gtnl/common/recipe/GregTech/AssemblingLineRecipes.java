    ...
    public void loadRecipes() {
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTNLItemList.LargeArcSmelter.get(64), GTNLItemList.LargeArcSmelter.get(64),
                ItemList.ArcFurnaceUEV.get(32), new ItemStack(LanthItemList.ELECTRODE_CASING, 64),
                new ItemStack(GregTechAPI.sBlockCasings10, 32, 6),
                GTModHandler.getModItem(KekzTech.ID, "kekztech_lapotronicenergyunit_block", 64),
                new ItemStack(Loaders.FRF_Coil_2, 4, 0), ItemList.Robot_Arm_UEV.get(16),
                ItemList.Electric_Motor_UEV.get(16), ItemList.Conveyor_Module_UEV.get(16),
                GTOreDictUnificator.get(OrePrefixes.wireGt16, Materials.SuperconductorUEV, 8),
                new Object[] { OrePrefixes.circuit.get(Materials.UIV), 8 }, GregtechItemList.Laser_Lens_Special.get(4),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.lens, Materials.Dilithium, 16),
                ...
                ItemRefer.Compact_Fusion_Coil_T2.get(32), new ItemStack(LanthItemList.ELECTRODE_CASING, 64),
                new ItemStack(GregTechAPI.sBlockMachines, 32, 15164), ItemList.Emitter_UHV.get(16),
                ItemList.Electric_Pump_UHV.get(16), ItemList.Electric_Piston_UHV.get(16),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GregtechItemList.Industrial_Centrifuge.get(64), GTNLItemList.LargeCentrifuge.get(64),
                ...
                GTModHandler.getModItem(TecTech.ID, "gt.blockcasingsTT", 64, 6), ItemList.Electric_Motor_UEV.get(16),
                ItemList.Field_Generator_UEV.get(16), MaterialsElements.STANDALONE.HYPOGEN.getRotor(16),
                new Object[] { OrePrefixes.circuit.get(Materials.UIV), 16 }, new ItemStack(huiCircuit, 16, 4),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTNLItemList.LargeElectrolyzer.get(64), GTNLItemList.LargeElectromagnet.get(64),
                ...
                new Object[] { OrePrefixes.circuit.get(Materials.UHV), 64 }, GregtechItemList.Laser_Lens_Special.get(2),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTOreDictUnificator.get(OrePrefixes.frameGt, Materials.Neutronium, 16),
                ...
                ItemList.Emitter_UHV.get(4), GTOreDictUnificator.get(OrePrefixes.plateDense, Materials.CallistoIce, 8),
                ...
                GTOreDictUnificator.get(OrePrefixes.plateDense, Materials.Ledox, 8),
                GTOreDictUnificator.get(OrePrefixes.plateDense, Materials.Ledox, 8),
                GTOreDictUnificator.get(OrePrefixes.screw, Materials.Osmiridium, 64), ItemList.NuclearStar.get(1), },
            new FluidStack[] { Materials.SuperCoolant.getFluid(32000), Materials.Infinity.getMolten(5760),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTNLItemList.LargeIndustrialLathe.get(64), GTNLItemList.Laser_Cooling_Casing.get(16),
                ItemList.Neutronium_Casing.get(64), ItemList.Electric_Motor_UEV.get(32),
                ItemList.Electric_Piston_UEV.get(32), ItemList.Field_Generator_UEV.get(8),
                new Object[] { OrePrefixes.circuit.get(Materials.UEV), 16 }, new ItemStack(huiCircuit, 16, 4),
                ...
                GTOreDictUnificator.get(OrePrefixes.wireGt16, Materials.SuperconductorUEV, 8), },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(96000),
                Materials.Lubricant.getFluid(64000), Materials.SuperCoolant.getFluid(64000) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            (int) TierEU.RECIPE_UV,
            1,
            new Object[] { GTNLItemList.LargeMixer.get(16), GTNLItemList.LargeMixer.get(16),
                GTNLItemList.LargeMixer.get(16), GTNLItemList.LargeMixer.get(16),
                GTModHandler.getModItem(TecTech.ID, "gt.blockcasingsTT", 16, 0), ItemList.Electric_Motor_UHV.get(12),
                ItemList.Electric_Piston_UHV.get(12), ItemList.Field_Generator_UV.get(1),
            ...
            new FluidStack[] { MaterialsAlloy.INDALLOY_140.getFluidStack(86400), Materials.Iridium.getMolten(34560),
                Materials.Lubricant.getFluid(64000), Materials.SuperCoolant.getFluid(64000) },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTModHandler.getModItem(TecTech.ID, "gt.blockcasingsTT", 2, 8),
                GTModHandler.getModItem(AppliedEnergistics2.ID, "tile.BlockCreativeEnergyCell", 1),
                GTNLItemList.EnhancementCore.get(1), ItemList.Field_Generator_UHV.get(12),
                ...
                GregtechItemList.Laser_Lens_Special.get(1), },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(96000),
                Materials.Infinity.getMolten(36864), Materials.UUMatter.getFluid(64000),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            (int) TierEU.RECIPE_UHV,
            1,
            new Object[] { GTNLItemList.LargeCutter.get(64), new ItemStack(LanthItemList.ELECTRODE_CASING, 64),
                GTModHandler.getModItem(TecTech.ID, "gt.blockcasingsTT", 32, 6), ItemList.Electric_Motor_UEV.get(32),
                ItemList.Conveyor_Module_UHV.get(32), new ItemStack(huiCircuit, 16, 4),
                new Object[] { OrePrefixes.circuit.get(Materials.UIV), 16 }, GregtechItemList.Laser_Lens_Special.get(1),
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTNLItemList.LargeMacerationTower.get(64), GregtechItemList.Maceration_Upgrade_Chip.get(64),
                new ItemStack(GregTechAPI.sBlockCasings8, 64, 10), ItemList.Electric_Motor_UEV.get(64),
                new ItemStack(huiCircuit, 16, 4), new Object[] { OrePrefixes.circuit.get(Materials.UIV), 16 },
                ...
                GTOreDictUnificator.get(OrePrefixes.nanite, Materials.Glowstone, 64), },
            new FluidStack[] { MaterialMisc.MUTATED_LIVING_SOLDER.getFluidStack(96000),
                Materials.Neutronium.getMolten(147456), MaterialsAlloy.PIKYONIUM.getFluidStack(18432) },
