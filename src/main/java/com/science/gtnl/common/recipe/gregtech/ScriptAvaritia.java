    ...
    public void loadRecipes() {
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                ":[]^_=?~!",
                'A',
                new ItemStack(GregTechAPI.sBlockMachines, 1, SpaceElevatorController.ID),
                'B',
                new ItemStack(GregTechAPI.sBlockMachines, 1, SpaceElevatorModuleAssemblerT3.ID),
                'C',
                new ItemStack(GregTechAPI.sBlockMachines, 1, SpaceElevatorModuleMinerT3.ID),
                'D',
                new ItemStack(GregTechAPI.sBlockMachines, 1, SpaceElevatorModulePumpT3.ID),
                'E',
                new ItemStack(GregTechAPI.sBlockMachines, 1, SpaceElevatorModuleManager.ID),
                'F',
                new ItemStack(GregTechAPI.sBlockMachines, 1, SpaceElevatorModuleResearch.ID),
                'G',
                ...
                '9',
                new ItemStack(GregTechAPI.sBlockMachines, 1, PlanetaryGasSiphonController.ID),
                'a',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                '1',
                new ItemStack(GregTechAPI.sBlockMachines, 1, DysonSwarmController.ID),
                '2',
