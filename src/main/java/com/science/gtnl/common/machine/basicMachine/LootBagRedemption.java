...
public class LootBagRedemption extends MTEBasicMachine {
    ...
    public LootBagRedemption(int aID, String aName, String aNameRegional, int aTier) {
        super(
            ...
            aTier,
            1,
            new String[] { StatCollector.translateToLocal("gtnl.machine.loot_bag_redemption.tooltip.0"),
                StatCollector.translateToLocal("gtnl.machine.loot_bag_redemption.tooltip.1"),
                StatCollector.translateToLocal("gtnl.machine.loot_bag_redemption.tooltip.2"),
                StatCollector.translateToLocal("gtnl.machine.loot_bag_redemption.tooltip.3"),
                StatCollector.translateToLocal("gtnl.machine.loot_bag_redemption.tooltip.4"),
                StatCollector.translateToLocal("gtnl.machine.loot_bag_redemption.tooltip.5") },
            2,
            9,
            TextureFactory.of(
