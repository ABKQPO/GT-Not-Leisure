...
public class LargeSteamFluidExtractor extends SteamMultiMachineBase<LargeSteamFluidExtractor>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final String LSFE_STRUCTURE_FILE_PATH = RESOURCE_ROOT_ID + ":"
        + "multiblock/large_steam_fluid_extractor";
    private static final String[][] shape = StructureUtils.readStructureFromFile(LSFE_STRUCTURE_FILE_PATH);
    ...
    public IStructureDefinition<LargeSteamFluidExtractor> getStructureDefinition() {
        return StructureDefinition.<LargeSteamFluidExtractor>builder()
            .addShape(STRUCTURE_PIECE_MAIN, transpose(shape))
            .addElement(
                'A',
                GTStructureChannels.TIER_MACHINE_CASING.use(
                    ofChain(
                        buildSteamWirelessInput(LargeSteamFluidExtractor.class).casingIndex(getCasingTextureID())
                            .dot(1)
                            .build(),
                        buildSteamBigInput(LargeSteamFluidExtractor.class).casingIndex(getCasingTextureID())
                            .dot(1)
                            .build(),
                        buildSteamInput(LargeSteamFluidExtractor.class).casingIndex(getCasingTextureID())
                            .dot(1)
                            .build(),
                        buildHatchAdder(LargeSteamFluidExtractor.class).casingIndex(getCasingTextureID())
                            .dot(1)
                            .atLeast(
                            ...
                            .buildAndChain(
                                onElementPass(
                                    x -> ++x.mCountCasing,
                                    ofBlocksTiered(
                                        LargeSteamFluidExtractor::getTierMachineCasing,
            ...
            .addElement(
                ...
                GTStructureChannels.TIER_MACHINE_CASING.use(
                    ofBlocksTiered(
                        LargeSteamFluidExtractor::getTierGearCasing,
            ...
            .addElement(
                ...
                GTStructureChannels.TIER_MACHINE_CASING.use(
                    ofBlocksTiered(
                        LargeSteamFluidExtractor::getTierFrameCasing,
            ...
            .addElement(
                ...
                GTStructureChannels.TIER_MACHINE_CASING.use(
                    ofBlocksTiered(
                        LargeSteamFluidExtractor::getTierFireboxCasing,
