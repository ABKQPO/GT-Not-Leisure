...
public class MicroorganismMaster extends WirelessEnergyMultiMachineBase<MicroorganismMaster> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("MicroorganismMasterRecipeType"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("Tooltip_MicroorganismMaster_Casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("Tooltip_MicroorganismMaster_Casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("Tooltip_MicroorganismMaster_Casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("Tooltip_MicroorganismMaster_Casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("Tooltip_MicroorganismMaster_Casing"), 1)
