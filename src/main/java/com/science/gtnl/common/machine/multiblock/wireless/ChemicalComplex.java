...
public class ChemicalComplex extends WirelessEnergyMultiMachineBase<ChemicalComplex> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("ChemicalComplexRecipeType"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("Tooltip_ChemicalComplex_Casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("Tooltip_ChemicalComplex_Casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("Tooltip_ChemicalComplex_Casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("Tooltip_ChemicalComplex_Casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("Tooltip_ChemicalComplex_Casing"), 1)
