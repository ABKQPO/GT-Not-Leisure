...
public class GiantFlotationTank extends WirelessEnergyMultiMachineBase<GiantFlotationTank> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("GiantFlotationTankRecipeType"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("Tooltip_GiantFlotationTank_Casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("Tooltip_GiantFlotationTank_Casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("Tooltip_GiantFlotationTank_Casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("Tooltip_GiantFlotationTank_Casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("Tooltip_GiantFlotationTank_Casing"), 1)
            .toolTipFinisher();
        return tt;
    }
}
