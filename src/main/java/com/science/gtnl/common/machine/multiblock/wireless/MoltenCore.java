...
public class MoltenCore extends WirelessEnergyMultiMachineBase<MoltenCore> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("MoltenCoreRecipeType"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("Tooltip_MoltenCore_Casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("Tooltip_MoltenCore_Casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("Tooltip_MoltenCore_Casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("Tooltip_MoltenCore_Casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("Tooltip_MoltenCore_Casing"), 1)
