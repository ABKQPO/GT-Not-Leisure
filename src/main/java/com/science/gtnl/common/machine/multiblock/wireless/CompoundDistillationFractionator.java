...
public class CompoundDistillationFractionator extends WirelessEnergyMultiMachineBase<CompoundDistillationFractionator> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("CompoundDistillationFractionatorRecipeType"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("Tooltip_CompoundDistillationFractionator_Casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("Tooltip_CompoundDistillationFractionator_Casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("Tooltip_CompoundDistillationFractionator_Casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("Tooltip_CompoundDistillationFractionator_Casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("Tooltip_CompoundDistillationFractionator_Casing"), 1)
            .toolTipFinisher();
        return tt;
    }
