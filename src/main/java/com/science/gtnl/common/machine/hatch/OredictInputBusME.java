...
public class OredictInputBusME extends MTEHatchInputBusME {

    @Nullable
    private String oreDict;

    public OredictInputBusME(int aID, String aName, String aNameRegional) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new OredictInputBusME(mName, autoPullAvailable, mTier, mDescriptionArray, mTextures);
    }

    @Override
    public String[] getDescription() {
        return new String[] { StatCollector.translateToLocal("Tooltip_OredictInputBusME_00"),
            StatCollector.translateToLocal("Tooltip_OredictInputBusME_01"),
            StatCollector.translateToLocal("Tooltip_OredictInputBusME_02"),
            StatCollector.translateToLocal("Tooltip_OredictInputBusME_03"),
            StatCollector.translateToLocal("Tooltip_OredictInputBusME_04"),
            StatCollector.translateToLocal("Tooltip_OredictInputBusME_05"),
            StatCollector.translateToLocal("Tooltip_OredictInputBusME_06"),
    ...
    public AENetworkProxy getProxy() {
        if (gridProxy == null) {
            if (getBaseMetaTileEntity() instanceof IGridProxyable gridProxyable) {
                gridProxy = new AENetworkProxy(gridProxyable, "proxy", GTNLItemList.OredictInputBusME.get(1), true);
    ...
    public String[] getInfoData() {
        ...
        String oreDictStatusKey = hasOreDict()
