...
public class VortexMatterCentrifuge extends WirelessEnergyMultiMachineBase<VortexMatterCentrifuge> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("VortexMatterCentrifugeRecipeType"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("Tooltip_VortexMatterCentrifuge_Casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("Tooltip_VortexMatterCentrifuge_Casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("Tooltip_VortexMatterCentrifuge_Casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("Tooltip_VortexMatterCentrifuge_Casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("Tooltip_VortexMatterCentrifuge_Casing"), 1)
            .toolTipFinisher();
        return tt;
    }
}
