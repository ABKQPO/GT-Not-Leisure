...
public class MegaWiremill extends WirelessEnergyMultiMachineBase<MegaWiremill> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("MegaWiremillRecipeType"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("Tooltip_MegaWiremill_Casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("Tooltip_MegaWiremill_Casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("Tooltip_MegaWiremill_Casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("Tooltip_MegaWiremill_Casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("Tooltip_MegaWiremill_Casing"), 1)
