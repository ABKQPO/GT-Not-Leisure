...
public class PhaseChangeCube extends WirelessEnergyMultiMachineBase<PhaseChangeCube> {
    ...
    public MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(StatCollector.translateToLocal("PhaseChangeCubeRecipeType"))
            ...
            .addInputBus("0+", StatCollector.translateToLocal("Tooltip_PhaseChangeCube_Casing"), 1)
            .addOutputBus("0+", StatCollector.translateToLocal("Tooltip_PhaseChangeCube_Casing"), 1)
            .addInputHatch("0+", StatCollector.translateToLocal("Tooltip_PhaseChangeCube_Casing"), 1)
            .addOutputHatch("0+", StatCollector.translateToLocal("Tooltip_PhaseChangeCube_Casing"), 1)
            .addEnergyHatch("0+", StatCollector.translateToLocal("Tooltip_PhaseChangeCube_Casing"), 1)
